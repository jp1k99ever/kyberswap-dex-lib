...
type ALMConfig struct {
	...
	// Adapter optionally points at an exactInputSingle shim. The production
	// EverlongCvammAdapter surfaces partial fills through amountUnused; an
	// exactInputSingle-style shim would instead fail closed on them.
